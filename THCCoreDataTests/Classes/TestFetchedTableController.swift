...
//        let mock = MockFetchedResultsDelegate()
//        let adapter = FetchedResultsControllerDelegateAdapter(delegate:mock)
//        adapter.controller(NSFetchedResultsController(), didChangeObject: NSManagedObject(), atIndexPath: nil, forChangeType: NSFetchedResultsChangeType.Insert, newIndexPath: NSIndexPath(forRow: 1, inSection: 0))
//        
//        XCTAssertTrue(mock.called)
//    }
//    
...
//        let mock = MockFetchedResultsDelegate()
//        let adapter = FetchedResultsControllerDelegateAdapter(delegate:mock)
//        adapter.controller(NSFetchedResultsController(), didChangeObject: NSManagedObject(), atIndexPath: NSIndexPath(forRow: 1, inSection: 0), forChangeType: NSFetchedResultsChangeType.Update, newIndexPath: nil)
//        XCTAssertTrue(mock.called)
//    }
//    
...
//        let mock = MockFetchedResultsDelegate()
//        let adapter = FetchedResultsControllerDelegateAdapter(delegate:mock)
//        adapter.controller(NSFetchedResultsController(), didChangeObject: NSManagedObject(), atIndexPath: NSIndexPath(forRow: 1, inSection: 0), forChangeType: NSFetchedResultsChangeType.Delete, newIndexPath: nil)
//        XCTAssertTrue(mock.called)
//    }
//    
//    func testMoveObject() {
...
//        let mock = MockFetchedResultsDelegate()
//        let adapter = FetchedResultsControllerDelegateAdapter(delegate:mock)
//        adapter.controller(NSFetchedResultsController(), didChangeObject: NSManagedObject(), atIndexPath: NSIndexPath(forRow: 1, inSection: 0), forChangeType: NSFetchedResultsChangeType.Move, newIndexPath: NSIndexPath(forRow: 2, inSection: 0))
//        XCTAssertTrue(mock.called)
//    }
//    
...
//            @objc var name: String {get{ return "" }}
//            @objc var indexTitle: String? {get{ return "" }}
//            @objc var numberOfObjects: Int {get { return 0 }}
//            @objc var objects: [NSManagedObject]? { get {return [NSManagedObject()]} }
//        }
//        let mock = MockFetchedResultsDelegate()
//        let adapter = FetchedResultsControllerDelegateAdapter(delegate:mock)
...
//    
//    func testFetch() {
//        self.manager.mainContext.createObject(Stub)
//        do {
...
//        class MockTableView: UITableView {
//            var called = false
//            private override func reloadRowsAtIndexPaths(indexPaths: [NSIndexPath], withRowAnimation animation: UITableViewRowAnimation) {
//                self.called = true
//                let indexPath = indexPaths[0] as NSIndexPath
//                XCTAssertEqual(NSIndexPath(forRow: 1, inSection: 0), indexPath)
//                XCTAssertEqual(UITableViewRowAnimation.Fade, animation)
